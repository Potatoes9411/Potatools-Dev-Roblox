mRGB(180,60,60) },
    { name = "Zombie Uprising",      id = 6422081360,      cat = "SURVIVAL", icon = "ðŸ§Ÿ", accent = Color3.fromRGB(120,200,80) },
    { name = "The Rake",             id = 2413927524,      cat = "HORROR",   icon = "ðŸ”ª", accent = Color3.fromRGB(180,60,60) },
    { name = "Stop it Slender",      id = 166455425,       cat = "HORROR",   icon = "ðŸ¤«", accent = Color3.fromRGB(120,120,150) },
    { name = "Night of the Alive",   id = 8329154271,      cat = "HORROR",   icon = "ðŸ§Ÿ", accent = Color3.fromRGB(120,200,80) },
    { name = "Rooms",                id = 1226739008,      cat = "HORROR",   icon = "ðŸšª", accent = Color3.fromRGB(255,90,60) },
    { name = "Interminable Rooms",   id = 10264317398,     cat = "HORROR",   icon = "ðŸšª", accent = Color3.fromRGB(255,90,60) },
    { name = "Decaying Winter",      id = 8605456127,      cat = "RPG",      icon = "â„ï¸", accent = Color3.fromRGB(160,140,120) },
    { name = "Dummies vs Noobs",     id = 9905257577,      cat = "FPS",      icon = "ðŸŽ¯", accent = Color3.fromRGB(120,180,255) },
    { name = "Polybattle 2",         id = 7283293682,      cat = "FPS",      icon = "ðŸŽ¯", accent = Color3.fromRGB(120,180,255) },
    { name = "Big Paintball 2",      id = 10482319449,     cat = "FPS",      icon = "ðŸŽ¨", accent = Color3.fromRGB(120,200,255) },
    { name = "Ro-Piece",             id = 3296216690,      cat = "RPG",      icon = "ðŸ´â€â˜ ï¸", accent = Color3.fromRGB(255,160,60) },
    { name = "Blox Fruits 2",        id = 2753915549,      cat = "RPG",      icon = "ðŸŽ", accent = Color3.fromRGB(255,160,60) },
    { name = "Booga Booga",          id = 165323793,       cat = "SURVIVAL", icon = "ðŸª“", accent = Color3.fromRGB(120,180,100) },
    { name = "Booga Booga Reborn",   id = 10100404387,     cat = "SURVIVAL", icon = "ðŸª“", accent = Color3.fromRGB(120,180,100) },
    { name = "Wild Savanna",         id = 5705855144,      cat = "SURVIVAL", icon = "ðŸ¦", accent = Color3.fromRGB(180,140,80) },
    ...
    { name = "Creatures of Omegon",  id = 0,               cat = "SURVIVAL", icon = "ðŸ²", accent = Color3.fromRGB(120,200,120) },
    { name = "Roblox Titanic",       id = 211063917,       cat = "SURVIVAL", icon = "ðŸš¢", accent = Color3.fromRGB(86,156,240) },
    ...
    { name = "Restaurant Tycoon 2",  id = 6183195053,      cat = "TYCOON",   icon = "ðŸ½ï¸", accent = Color3.fromRGB(255,160,80) },
    { name = "Retail Tycoon 2",      id = 8163030208,      cat = "TYCOON",   icon = "ðŸª", accent = Color3.fromRGB(120,200,255) },
    { name = "2 Player Tycoon",      id = 1925813751,      cat = "TYCOON",   icon = "ðŸ­", accent = Color3.fromRGB(120,180,200) },
    { name = "Bedwars (Lobby)",      id = 6872265039,      cat = "ACTION",   icon = "ðŸ›ï¸", accent = Color3.fromRGB(120,180,255) },
    { name = "Roblox Boxing",        id = 3075264192,      cat = "ACTION",   icon = "ðŸ¥Š", accent = Color3.fromRGB(255,160,60) },
    { name = "Ro-Wrestle",           id = 5275351335,      cat = "ACTION",   icon = "ðŸ¤¼", accent = Color3.fromRGB(220,60,60) },
    { name = "Slap Battles",         id = 6405393098,      cat = "ACTION",   icon = "ðŸ‘‹", accent = Color3.fromRGB(245,196,76) },
    { name = "Find the Markers 2",   id = 5771057385,      cat = "FIND",     icon = "ðŸ–ï¸", accent = Color3.fromRGB(255,80,120) },
    { name = "Game Dev Tycoon",      id = 0,               cat = "TYCOON",   icon = "ðŸ’»", accent = Color3.fromRGB(120,180,200) },
    -- Nazuro-loader games
    { name = "99 Nights",            id = 79546208627805,  cat = "ACTION",   icon = "ðŸŒ™", accent = Color3.fromRGB(80,50,120) },
    { name = "Escape (Nazuro)",      id = 131623223084840, cat = "SURVIVAL", icon = "ðŸšª", accent = Color3.fromRGB(86,156,240) },
    { name = "Bronx",                id = 16472538603,     cat = "FPS",      icon = "ðŸŒ‡", accent = Color3.fromRGB(200,120,80) },
    { name = "Steal a Brainrot",     id = 109983668079237, cat = "ACTION",   icon = "ðŸ§ ", accent = Color3.fromRGB(180,120,255) },
    { name = "Dead Rails (Nazuro)",  id = 116495829188952, cat = "SURVIVAL", icon = "ðŸš‚", accent = Color3.fromRGB(180,140,80) },
    -- IdiotHub games
    { name = "Pet Catchers",         id = 16510724413,      cat = "SIMULATOR",icon = "ðŸ¾", accent = Color3.fromRGB(180,120,255) },
    { name = "Tycoon RNG",           id = 17601705136,      cat = "RNG",      icon = "ðŸŽ°", accent = Color3.fromRGB(180,180,200) },
    { name = "Card RNG",             id = 17181264920,      cat = "RNG",      icon = "ðŸƒ", accent = Color3.fromRGB(180,180,200) },
    { name = "Anime Card Battle",    id = 18138547215,      cat = "RPG",      icon = "âš”ï¸", accent = Color3.fromRGB(180,120,255) },
    { name = "Pets Go",              id = 18901165922,      cat = "RNG",      icon = "ðŸŽ²", accent = Color3.fromRGB(180,120,255) },
    { name = "Brainrot Giant",       id = 85896571713843,   cat = "ACTION",   icon = "ðŸ¦£", accent = Color3.fromRGB(180,120,255) },
    { name = "Grow a Garden (IH)",   id = 126884695634066,  cat = "SIMULATOR",icon = "ðŸŒ±", accent = Color3.fromRGB(76,209,142) },
    { name = "Split or Steal (IH)",  id = 127742093697776,  cat = "ACTION",   icon = "ðŸ˜ˆ", accent = Color3.fromRGB(180,80,120) },
    { name = "Tap Simulator (IH)",   id = 75992362647444,   cat = "CLICKER",  icon = "ðŸ‘†", accent = Theme.Accent },
    { name = "Grow a Garden 2 (IH)", id = 97598239454123,   cat = "SIMULATOR",icon = "ðŸ¥•", accent = Color3.fromRGB(120,200,120) },
}
